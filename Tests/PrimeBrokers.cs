...
namespace SwaggerWebAPI
{
    class PrimeBrokers
    {
        ...
        static string lattise_url = "//*[@id='PrimeBroker_PrimeBroker_GetPrimeBrokers']/div[1]/h3/span[2]/a",
                         lattise_Try = "//*[@id='PrimeBroker_PrimeBroker_GetPrimeBrokers_content']/form/div[2]/input",
                         lattise_code = "//*[@id='PrimeBroker_PrimeBroker_GetPrimeBrokers_content']/div[2]/div[4]/pre",
                         userName = "//div[@id='PrimeBroker_PrimeBroker_GetPrimeBrokers_content']/form/table/tbody/tr/td/input[@name='Username']",
                        lattise_body = "//*[@id='PrimeBroker_PrimeBroker_GetPrimeBrokers_content']/div[2]/div[3]/pre/code";


        public PrimeBrokers(IWebDriver driver, Dictionary<string, ExcelAPI> ExcelApiList, ExtentReports ExtReport)
        {
            this.Driver = driver;
        ...
        public void GetPrimeBrokers()
        {
            test = ExtReport.CreateTest("TS_081_GetPrimeBrokers").Info("Test Started");

            string val1 = ValidationExcelAPI.GetCellData("DatabaseTopic", 129, 3);
            string val2 = ValidationExcelAPI.GetCellData("DatabaseTopic", 129, 4);
            ...
            if (resCode == "200")
            {
                ...
                {
                    test.Log(Status.Pass, "GetPrimeBrokers Response contains PrimeBroker Code " + val1 + ", CounterpartyID " + val2);
                    test.Log(Status.Pass, "Test is Pass");
                }
                else
                {
                    test.Log(Status.Fail, "GetPrimeBrokers Response is Failed!");
                    Assert.Fail("GetPrimeBrokers Response is Failed!" );
                }
            }
            else
            {
