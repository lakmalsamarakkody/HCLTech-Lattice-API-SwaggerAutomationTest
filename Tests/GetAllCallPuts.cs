...
namespace SwaggerWebAPI
{
    class GetAllCallPuts
    {
        ...
        static string lattise_url = "//*[@id='DatabaseTopic_DatabaseTopic_GetAllCallPuts']/div[1]/h3/span[2]/a",
                         lattise_Try = "//*[@id='DatabaseTopic_DatabaseTopic_GetAllCallPuts_content']/form/div[2]/input",
                         lattise_code = "//*[@id='DatabaseTopic_DatabaseTopic_GetAllCallPuts_content']/div[2]/div[4]/pre",
                         userName = "//*[@id='DatabaseTopic_DatabaseTopic_GetAllCallPuts_content']/form/table/tbody/tr/td/input[@name='Username']",
                        lattise_body = "//*[@id='DatabaseTopic_DatabaseTopic_GetAllCallPuts_content']/div[2]/div[3]/pre/code";


        public GetAllCallPuts(IWebDriver driver, Dictionary<string, ExcelAPI> ExcelApiList, ExtentReports ExtReport)
        {
            this.Driver = driver;
        ...
        public void Get_AllCallPuts()
        {

            test = ExtReport.CreateTest("TS_052_GetAllCallPuts").Info("Test Started");

            string val1 = ValidationExcelAPI.GetCellData("DatabaseTopic", 76, 3);
            ...
            if (resCode == "200")
            {
                ...
                {
                    test.Log(Status.Pass, "GetAllCcypairs Response body contains PrimeBrokers " + val1);
